...
## 3.3 The Correctly-Aligned Comparison

The heuristic of Section 3.2 predicts $\mathbb{E}[\omega(b) \mid a \text{ prime}] - \mathbb{E}[\omega(b) \mid a \text{ composite}]$. To test this, we must compute the **full** conditional expectations—including contributions from cases where $b$ is prime.
